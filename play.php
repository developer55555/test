...
$zongyi = "#<li  title='(.*?)' class='w-newfigure w-newfigure-180x153'><a href='(.*?)' data-daochu=to=(.*?) class='js-link'>#";

preg_match_all($jianjie, $tvinfo, $jjarr);
preg_match_all($jianjie1, $tvinfo, $jjarr);
...
preg_match_all($zongyi, $tvinfo, $zy);
...
foreach ($dyzy as $key1 => $mz) {
?>

<a href='<?php echo $dyzy1[$key1];?>' target='ajax'><?php echo $mz;?></a>
...
<a  href="/cili.php?sousuo=<?php echo $timu;?>&qiehuan=1" class="am-btn am-btn-default lipbtn">点击查看</a><?php
}
?>
