...
<li class="menu-item"><a href="./zongyi.php">综艺</a></li>
...
<ul class="sub-menu">
	<li class="menu-item"><a target="_blank" href="zhi.html">电视直播</a></li>
</ul>
</li>-->
<li class="menu-item"><?php echo $aik['top_ad'];?></li>
<li class="menu-item"><?php echo $aik['top1_ad'];?></li>
<!--<li class="menu-item"><a href="zw/index.php"><font color="#FF0000">『聚合直播』</font></a></li>-->
</ul>
		</div>
